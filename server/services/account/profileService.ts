  ...
  return {
    ...
    async updateProfile(userId: string, body: ProfileUpdate) {
      ...
      try {
        ...
        await client.query("INSERT INTO audit_logs(actor_id,action,target_type,target_id,detail) VALUES($1,'profile.update','user_profile',$2::text,$3::jsonb)", [userId, userId, JSON.stringify({ publicFields: body.publicFields })]);
